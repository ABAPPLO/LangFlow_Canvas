...
if TYPE_CHECKING:
    ...
    from lfx.components.models_and_agents.multimodal_model import MultimodalModelComponent
...
_dynamic_imports = {
    ...
    "MultimodalModelComponent": "multimodal_model",
